...
var simulatedSystem = "isolated_system";
...
function drawGUI() {
	...
	c.beginPath();
	c.font = "12px Arial";
	c.fillText("system: " + simulatedSystem, 20, topHeight);
	c.fillText("zoom scale: " + scale, 20, 2 * topHeight);
	c.fillText("scale step: " + scaleStep, 20, 3 * topHeight);
	c.fillText("offset step: " + offsetStep, 20, 4 * topHeight);
	c.fillText("entities: " + entities.length, 20, 5 * topHeight);
	c.fillText("spawn range: " + spawnRange, 20, innerHeight - 3 * bottomHeight);
	c.fillText("cull range: " + cullRange, 20, innerHeight - 2 * bottomHeight);
	c.fillText("isPaused: " + isPaused, 20, innerHeight - bottomHeight);
	c.closePath();
...
function spawnRoid(isUser, x, y) {
	if (isUser) {
		...
		entities.push(new Entity("ID" + idCount, x, y, roidMass, roidDX, roidDY, false));
