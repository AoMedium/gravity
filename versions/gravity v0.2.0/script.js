...
function drawGUI() {
	...
	c.fillText("frame count: " + frameCount, 20, 23 * guiHeight + guiOffset + 100);
	c.fillText("[n][m] time step: " + timeStep + "x", 20, 24 * guiHeight + guiOffset + 100);
	c.fillText("[p]    isPaused: " + isPaused, 20, 25 * guiHeight + guiOffset + 100);
	c.closePath();
