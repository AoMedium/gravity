...
var sol_beta = new EntitySystem("sol_beta");
	...
	sol_beta.initSystemObjects = function() {
		...
		var Sol_Beta_Major = new PrimaryObject("f", "Sol Beta Major", 8240000, [-AU * 0, AU * 0], [0,0]); //35, 25
		var Sol_Beta_Minor = new PrimaryObject("o", "Sol Beta Minor", 115000, AU * 0.5);
		...
		var Vera = new PrimaryObject("f", "Vera", 14134000, [AU * 30, -AU * 20], [0,0]);
			//Vera.center = "Sol Beta Major"
